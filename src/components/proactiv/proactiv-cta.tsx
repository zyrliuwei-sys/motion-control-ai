    ...
    <section className="relative overflow-hidden bg-[#08090a] py-20 text-white md:py-28">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1280px] px-8">
        <div className="flex flex-col items-center justify-between gap-10 md:flex-row md:items-center md:gap-12">
          ...
          <Link
            href={ctaHref}
            className="group inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-[6px] bg-[#39c3ef] px-5 py-3 text-base font-medium text-[#061014] transition-transform duration-200 hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#39c3ef] active:scale-[0.98]"
          >
            {ctaLabel}
            <ArrowRight
              aria-hidden="true"
  ...
  return (
    <div className="relative mx-auto mt-2 h-[252px] w-full max-w-[512px] [perspective:800px] sm:h-[380px] md:mt-8 md:h-[544px]">
      <button
        ...
        aria-pressed={isOpen}
        className="proactiv-cta-laptop absolute top-0 left-1/2 h-[544px] w-[512px] origin-top -translate-x-1/2 scale-[0.45] cursor-pointer appearance-none border-0 bg-transparent p-0 text-left outline-none focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#39c3ef] sm:scale-[0.7] md:scale-100"
        data-open={isOpen}
